...
CJNIEXPORT jobject JNICALL Java_com_single_user_login_UserLogin_00024CppProxy_createUserInterface(JNIEnv* jniEnv, jobject /*this*/)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
        auto r = ::UserLogin::UserLogin::createUserInterface();
        return ::djinni::release(::djinni_generated::NativeUserLogin::fromCpp(jniEnv, r));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, 0 /* value doesn't matter */)
}
